...
-- object: public.password_resets | type: TABLE --
-- DROP TABLE IF EXISTS public.password_resets CASCADE;
CREATE TABLE public.password_resets (
	idpassword_resets bigint NOT NULL GENERATED ALWAYS AS IDENTITY ,
	id_users bigint NOT NULL,
	token_hash bytea NOT NULL,
	expires_at timestamptz NOT NULL,
	used_at timestamptz,
	created_at timestamptz NOT NULL DEFAULT NOW(),
	CONSTRAINT password_resets_pk PRIMARY KEY (idpassword_resets),
	CONSTRAINT password_resets_token_hash_len_chk CHECK (octet_length(token_hash) = 32)
);
-- ddl-end --
...
CREATE TABLE public.company_address (
	...
	CONSTRAINT company_address_pk PRIMARY KEY (id_addresses,id_companies)
);
-- ddl-end --
...
CREATE TABLE public.company_phone (
	...
	started_at timestamptz NOT NULL DEFAULT now(),
	ended_at timestamptz,
	CONSTRAINT company_phone_pk PRIMARY KEY (id_phones,id_companies)
);
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.company_email OWNER TO postgres;
-- ddl-end --
...
CREATE TABLE public.sessions (
	...
	CONSTRAINT sessions_pk PRIMARY KEY (idsessions)
);
-- ddl-end --
...
-- DROP INDEX IF EXISTS public.idx_sessions_expires_at CASCADE;
CREATE INDEX idx_sessions_expires_at ON public.sessions
USING btree
(
	expires_at
);
...
-- object: idx_sessions_revoked_at | type: INDEX --
-- DROP INDEX IF EXISTS public.idx_sessions_revoked_at CASCADE;
CREATE INDEX idx_sessions_revoked_at ON public.sessions
USING btree
(
	revoked_at
);
...
-- object: password_resets_user_id_idx | type: INDEX --
-- DROP INDEX IF EXISTS public.password_resets_user_id_idx CASCADE;
CREATE INDEX password_resets_user_id_idx ON public.password_resets
USING btree
(
	id_users
);
...
-- object: password_resets_active_idx | type: INDEX --
-- DROP INDEX IF EXISTS public.password_resets_active_idx CASCADE;
CREATE INDEX password_resets_active_idx ON public.password_resets
USING btree
(
	id_users,
	expires_at
...
-- object: password_resets_token_hash_uniq | type: INDEX --
-- DROP INDEX IF EXISTS public.password_resets_token_hash_uniq CASCADE;
CREATE UNIQUE INDEX password_resets_token_hash_uniq ON public.password_resets
USING btree
(
	token_hash
);
