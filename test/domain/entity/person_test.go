...
func TestEntityPeople(t *testing.T) {
	_, err := entity.NewPeople(dto.PeopleRequest{})
	...
	_, err = entity.NewPeople(dto.PeopleRequest{FirstName: "John", LastName: ""})
	...
	_, err = entity.NewPeople(dto.PeopleRequest{FirstName: "John", LastName: "Doe", BirthDate: ""})
	...
	_, err = entity.NewPeople(dto.PeopleRequest{FirstName: "John", LastName: "Doe", BirthDate: "28/08/1999", MotherName: ""})
	...
	_, err = entity.NewPeople(dto.PeopleRequest{FirstName: "John", LastName: "Doe", BirthDate: "28/08/1999", MotherName: "Jane", FatherName: ""})
	...
	_, err = entity.NewPeople(dto.PeopleRequest{FirstName: "John", LastName: "Doe", BirthDate: "28/08/1999", MotherName: "Jane", FatherName: "Jack"})
	...
	_, err = entity.NewPeople(dto.PeopleRequest{FirstName: "John", LastName: "Doe", BirthDate: "28/08/1999", MotherName: "Jane", FatherName: "Jack", Gender: "M"})
