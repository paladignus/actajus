...
func (m *AuthMapper) ChangePasswordInputToNormalized(input command.ChangePasswordCommand) (ChangePasswordNormalized, error) {
...
func (m *AuthMapper) RequestPasswordResetInputToNormalized(input command.RequestPasswordResetCommand) (RequestPasswordResetNormalized, error) {
	vs := m.validator.ValidateStruct(input)
...
func (m *AuthMapper) ConfirmPasswordResetInputToNormalized(input command.ConfirmPasswordResetCommand) (ConfirmPasswordResetNormalized, error) {
	vs := m.validator.ValidateStruct(input)
