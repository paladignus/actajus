...
func NewPhoneRepository(exec sharedpostgres.Executor) PhoneRepository {
	return PhoneRepository{exec: exec}
}

func (r PhoneRepository) Create(ctx context.Context, phone *phoneDomain.Phone) error {
...
func (r PhoneRepository) Update(ctx context.Context, phone phoneDomain.Phone) error {
...
func (r PhoneRepository) Delete(ctx context.Context, phone phoneDomain.Phone) error {
...
func (r PhoneRepository) FindByIDCompany(ctx context.Context, idCompany int64) (*phoneDomain.Phone, error) {
	query := `
		SELECT
