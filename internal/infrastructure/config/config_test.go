...
func TestLoad(t *testing.T) {
	...
	envVars := []string{
		...
		"NATS_MAX_BYTES", "NATS_REPLICAS", "NATS_MAX_DELIVER", "NATS_MAX_ACK_PENDING", "NATS_MAX_AGE", "NATS_ACK_WAIT", "NATS_CONNECTION_TIMEOUT", "NATS_REQUEST_TIMEOUT",
	}
	...
	tests := []struct {
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"NATS_CONSUMER_NAME": "actajus",
				"NATS_DURABLE_NAME":  "actajus",
				"NATS_REPLAY_POLICY": "all",
			},
			expected: Config{
				Server: ServerConfig{
					Port:     "9090",
