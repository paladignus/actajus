...
func (x *EmailResponse) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *CreateEmailRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *CreateEmailResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *UpdateEmailRequest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *UpdateEmailResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_email_v1_email_proto_rawDesc = []byte{
	...
	0x22, 0x39, 0x0a, 0x0d, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x25, 0x0a, 0x13, 0x43,
	...
	0x69, 0x64, 0x22, 0x3e, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x6d, 0x61, 0x69,
	...
	0x73, 0x73, 0x22, 0x25, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x6d, 0x61, 0x69,
	0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x32, 0xa6, 0x01, 0x0a, 0x0c, 0x45, 0x6d,
	0x61, 0x69, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4a, 0x0a, 0x0b, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1c, 0x2e, 0x65, 0x6d, 0x61, 0x69,
	0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x45, 0x6d, 0x61, 0x69, 0x6c,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x2e,
	...
	0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1c, 0x2e, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x2e, 0x76, 0x31,
	0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x55,
	...
	0x6a, 0x75, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x2f,
	0x76, 0x31, 0x3b, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_email_v1_email_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_email_v1_email_proto_goTypes = []interface{}{
	(*EmailResponse)(nil),       // 0: email.v1.EmailResponse
	(*CreateEmailRequest)(nil),  // 1: email.v1.CreateEmailRequest
	(*CreateEmailResponse)(nil), // 2: email.v1.CreateEmailResponse
	(*UpdateEmailRequest)(nil),  // 3: email.v1.UpdateEmailRequest
	(*UpdateEmailResponse)(nil), // 4: email.v1.UpdateEmailResponse
}
var file_email_v1_email_proto_depIdxs = []int32{
	1, // 0: email.v1.EmailService.CreateEmail:input_type -> email.v1.CreateEmailRequest
	3, // 1: email.v1.EmailService.UpdateEmail:input_type -> email.v1.UpdateEmailRequest
	2, // 2: email.v1.EmailService.CreateEmail:output_type -> email.v1.CreateEmailResponse
	4, // 3: email.v1.EmailService.UpdateEmail:output_type -> email.v1.UpdateEmailResponse
...
func file_email_v1_email_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_email_v1_email_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_email_v1_email_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
